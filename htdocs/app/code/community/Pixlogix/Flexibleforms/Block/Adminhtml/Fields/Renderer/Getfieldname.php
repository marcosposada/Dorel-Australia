 ...
 */
class Pixlogix_Flexibleforms_Block_Adminhtml_Fields_Renderer_Getfieldname extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    /**
    ...
    public function render(Varien_Object $row)
    {
        ...
        $optionsCollection = Mage::getModel('flexibleforms/fields')->getCollection()
                            ->addFieldToFilter('field_id',$fieldId)->getFirstItem();
        return $optionsCollection->getTitle();
    }
}