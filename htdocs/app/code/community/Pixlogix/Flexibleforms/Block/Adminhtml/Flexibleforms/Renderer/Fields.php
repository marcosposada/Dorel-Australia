 ...
 */
class Pixlogix_Flexibleforms_Block_Adminhtml_Flexibleforms_Renderer_Fields extends  Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    /**
    ...
    {
            $value = (string)Mage::getModel('flexibleforms/fields')->getCollection()->addFilter('form_id', $row->getId())->count();
            return $value;
    }
}