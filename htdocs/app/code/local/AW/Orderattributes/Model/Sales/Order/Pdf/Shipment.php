...
class AW_Orderattributes_Model_Sales_Order_Pdf_Shipment
    extends Varien_Object
    implements AW_Lib_Model_AdminhtmlPdf_Sales_Order_Pdf_ShipmentInterface
{
    ...
    public function getAddressSectionData()
    {
        $addressSectionData = array(
            'layout_type' => AW_Lib_Model_AdminhtmlPdf_Sales_Order_Pdf_Shipment::TWO_COLUMN_LAYOUT,
            'column'      => array(
                'left'  => array(
                    'title'  => null,
    ...
    {
        $sectionData = array(
            'layout_type' => AW_Lib_Model_AdminhtmlPdf_Sales_Order_Pdf_Shipment::ONE_COLUMN_LAYOUT,
            'column'      => array(
                'left'  => array(
