...
abstract class AW_Orderattributes_Block_Widget_Backend_ViewAbstract
    implements AW_Orderattributes_Block_Widget_Backend_ViewInterface
{
    /**
     ...
     *
     * @return AW_Orderattributes_Block_Widget_Backend_ViewAbstract
     */
