...
abstract class AW_Orderattributes_Block_Widget_Backend_FormAbstract
        implements AW_Orderattributes_Block_Widget_Backend_FormInterface
{
    /**
     ...
     *
     * @return AW_Orderattributes_Block_Widget_Backend_FormAbstract
     */
