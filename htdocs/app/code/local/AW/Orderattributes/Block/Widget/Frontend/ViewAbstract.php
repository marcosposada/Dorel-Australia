...
abstract class AW_Orderattributes_Block_Widget_Frontend_ViewAbstract
    implements AW_Orderattributes_Block_Widget_Frontend_ViewInterface
{
     ...
     *
     * @return AW_Orderattributes_Block_Widget_Frontend_ViewAbstract
     */
