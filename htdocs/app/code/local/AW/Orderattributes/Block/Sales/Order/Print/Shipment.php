...
class AW_Orderattributes_Block_Sales_Order_Print_Shipment extends Mage_Sales_Block_Order_Print_Shipment
{
    ...
    public function getShipmentAddressFormattedHtml($shipment)
    {
        ...
        $mockShippingAddress = Mage::getModel('aw_orderattributes/sales_order_address');
    ...
    public function getBillingAddressFormattedHtml($order)
    {
        ...
        $mockBillingAddress = Mage::getModel('aw_orderattributes/sales_order_address');
